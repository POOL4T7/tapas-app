...
import img from '../../../public/image/mundo-tapas-bar-restaurant.jpg'
...
export default function ComingSoon({color,height,contact}:any) {
  ...
  return (
    ...
    {
      langData? (
  <div className={`w-full ${height?'min-h-screen':''} flex items-center justify-center`}>
      ...
      <main className="flex flex-col items-center justify-center space-y-5">
        ...
        <p className={`text-xl text-${color?color:'black'}`} >am Checkpoint Charlie, Zimmerstraße 19, 10969 Berlin, Germany
        </p>
      </main>
    </div>):layout(color,height)
    }
    </>
    );
  }
  const layout= (color:any,height:any) =>(
    <div className={`w-full ${height?'min-h-screen':''} flex items-center justify-center`}>
        ...
        <main className="flex flex-col items-center justify-center space-y-5">
          ...
          <p className={`text-xl text-${color?color:'black'}`} >am Checkpoint Charlie, Zimmerstraße 19, 10969 Berlin, Germany</p>
