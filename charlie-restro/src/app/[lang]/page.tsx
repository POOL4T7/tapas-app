...
const OurServiceLanding = dynamic(() => import('@/component/ourServiceSection'), {
  ssr:false
});
...
const restaurantSchema = {
  ...
  "@graph": [
    {
      "@type": "WebSite",
      "@id": "https://checkpoint-charlie.tapas-mundo.com/#website",
      "url": "https://checkpoint-charlie.tapas-mundo.com/",
      "name": "Mundo Tapas - Checkpoint Charlie",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://checkpoint-charlie.tapas-mundo.com/?s={search_term_string}",
    ...
    },
    {
      ...
      "siteNavigation": [
        ...
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Menu",
          "url": "https://checkpoint-charlie.tapas-mundo.com/men%C3%BC-karte-menu-card/speisekarte-a-la-carte"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Group Offer",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/gruppenangebot"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Facilities",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/einrichtungen"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Gallery",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/galerie"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Reservations",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/reservierung"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Blog",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/blog"
        },
        {
          "@type": "SiteNavigationElement",
          "name": "Contact",
          "url": "https://checkpoint-charlie.tapas-mundo.com/en/kontakt"
        }
      ]
    }
  ]
...
const productSchema = {
  ...
  "image": "https://checkpoint-charlie.tapas-mundo.com/_next/image?url=%2Fimage%2Fcrousel%2Fslide2.webp&w=828&q=100",
  "description": "Looking for the best Spanish restaurant near Checkpoint Charlie in Berlin? Welcome to Tapas Mundo, the top destination for authentic Spanish tapas and Mediterranean cuisine in the heart of Berlin. Just steps away from the famous Checkpoint Charlie, our restaurant offers a cozy yet vibrant atmosphere where locals and tourists can indulge in delicious, freshly prepared dishes inspired by the rich culinary traditions of Spain.",
  "review": {
    "@type": "Review",
    "reviewBody": "Welcome to Tapas Mundo – Best Restaurant at Checkpoint Charlie in Berlin",
    "author": {
      "@type": "Organization",
      "name": "Mundo Tapas - Checkpoint Charlie"
    }
...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    title: 'Tapas Mundo Restaurant in Checkpoint Charlie, Berlin | Authentic Spanish Cuisine',
    description:
    ...
    alternates: {
      canonical: `https://checkpoint-charlie.tapas-mundo.com/${lang}`,
    },
  };
}
