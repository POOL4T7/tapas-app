...
//     // Remove any non-numeric characters except for commas and periods
//     // Replace commas with periods for decimal point consistency
//     let normalizedString = priceString
//       .replace(/[^0-9,.]+/g, ''); // Remove any non-numeric characters except commas and periods
...
//     const newDishes = offers[offerIndex][tab].Items.slice(currentLength, currentLength + 4);
//     setOfferStates(prevStates => ({
//       ...prevStates,
//       [offerIndex]: {
//         ...prevStates[offerIndex],
...
//             loadedCount: prevStates[offerIndex].loadedDishes[tab].loadedCount + 4
//           }
//         }
//       }
//     }));
...
//               <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-screen-lg mx-auto">
//                 <p style={{ background: 'goldenrod', color: 'white', padding: '1rem' }} className=" text-lg justify-end flex mb-3">
// {/*                   <span>&#8364;{offer.price} per person</span> */}
//                     <h2 className="text-xl font-semibold">{offer.name}</h2>
//                 </p>
//                 <div className="px-6 py-4">
...
//                     <div className="flex border-b w-full">
//                       <button
//                         className={`text-xl w-1/2 font-semibold py-2 px-4 rounded-lg focus:outline-none ${offerStates[index].activeTab === 'Food' ? 'text-white border-2 bg-[goldenrod] border-[goldenrod]' : 'rounded-none text-gray-700 bg-[#FCEFC0] border-[#FCEFC0]'}`}
//                         onClick={() => toggleTab('Food', index)}
//                       >
//                         Food
//                       </button>
