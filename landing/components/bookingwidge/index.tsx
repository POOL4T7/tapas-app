        ...
        <div>
          {header ? (
            ...
            <Button
              ...
              className=' h-full w-full px-4 py-4 bg-[#f5a524] rounded-none'
            >
              {langData[0]}
            </Button>
          ) : banner ? (
            <Button
              onPress={handleOpen}
              className='bg-[#f5a524] text-black px-3 py-1.5 md:px-4 md:py-2 rounded text-sm md:text-base'
            >
              {langData.button1}
            </Button>
          ) : (
