...
const headContent: Record<string, { title: string; description: string }> = {
  'getränkekarte-drinks-menu': {
    title: 'Menükarte - Genießen Sie unsere Getränkekarte im Mundo Bar Restaurant',
    description:
  ...
  'speisekarte-a-la-carte': {
    title: 'Menü à la carte - Erleben Sie authentische Aromen in der Mundo Tapas Bar',
    description:
  ...
  'brunch-buffet': {
    title: 'Brunch Buffet in Berlin – Köstlicher Spanischer Brunch in der Mundo Tapas Bar',
    description:
  ...
  'frühstucksmenü-breakfast-menu': {
    title: 'Frühstücksmenü in Berlin – Beginnen Sie Ihren Tag in der Mundo Tapas Bar',
    description:
...
export async function generateMetadata({ params }: { params: { menuItem: string[] } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alt-mariendorf.tapas-mundo.com/menükarte-menu-card/${lastSegment}`,
    },
  };
}
