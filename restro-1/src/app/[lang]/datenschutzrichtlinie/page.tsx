...
const PrivacyPolicy = dynamic(() => import("@/component/privacyPolicy/privacyPolicy"), {
  loading: () => <LoadingSkeleton />,ssr:false
});
export const metadata: Metadata = {
  title: "Datenschutzrichtlinie Mundo Alt-Mariendorf | Reservierungen & Anfragen",
  alternates: {
    canonical: 'https://alt-mariendorf.tapas-mundo.com/en/datenschutzrichtlinie',
  },
  description:
