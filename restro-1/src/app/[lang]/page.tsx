...
export const metadata: Metadata = {
  title:
    'Tapas Mundo Restaurant in Alt-Mariendorf, Berlin | Authentic Spanish Cuisine',
  alternates: {
    canonical: 'https://alt-mariendorf.tapas-mundo.euen',
  },
  description:
  ...
  '@graph': [
    {
      ...
      potentialAction: {
        '@type': 'SearchAction',
        target: 'https://alt-mariendorf.tapas-mundo.eu?s={search_term_string}',
    ...
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Menu',
      url: 'https://alt-mariendorf.tapas-mundo.eumen%C3%BCkarte-menu-card/speisekarte-a-la-carte',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Group Offer',
      url: 'https://alt-mariendorf.tapas-mundo.euen/gruppenangebot',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Facilities',
      url: 'https://alt-mariendorf.tapas-mundo.euen/einrichtungen',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Gallery',
      url: 'https://alt-mariendorf.tapas-mundo.euen/galerie',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Reservations',
      url: 'https://alt-mariendorf.tapas-mundo.euen/reservierung',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Blog',
      url: 'https://alt-mariendorf.tapas-mundo.euen/blog',
    },
    {
      '@type': 'SiteNavigationElement',
      name: 'Contact',
      url: 'https://alt-mariendorf.tapas-mundo.euen/kontakt',
    },
    {
      '@type': 'Restaurant',
      name: 'Mundo Tapas - Alt Mariendorf',
      image: 'https://alt-mariendorf.tapas-mundo.euimage/alt/banner/slide1.jpg',
      '@id': 'https://alt-mariendorf.tapas-mundo.eu#restaurant',
      url: 'https://alt-mariendorf.tapas-mundo.eu',
      telephone: '+49-3025294284',
      priceRange: '€€',
      menu: 'https://alt-mariendorf.tapas-mundo.eumen%C3%BCkarte-menu-card/speisekarte-a-la-carte',
      servesCuisine: ['Spanish cuisine', 'Latin American cuisine', 'Tapas'],
...
const productSchema = {
  ...
  image: 'https://alt-mariendorf.tapas-mundo.euimage/alt/banner/slide3.jpg',
  description:
    'Experience the authentic flavors of Spain at Mundo Tapas Bar & Restaurant in the heart of Alt-Mariendorf, Berlin. From traditional tapas and rich meat dishes to flavorful vegetarian options, our menu brings a true taste of Spanish cuisine to your table. Enjoy a warm, welcoming atmosphere perfect for casual dining, family gatherings, or special occasions.',
  review: {
    '@type': 'Review',
    reviewBody:
      'Mundo Tapas Bar & Restaurant in Berlin | Spanish Dining in Alt-Mariendorf',
