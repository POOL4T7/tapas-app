...
export default function ContactForm() {
  const [formData, setFormData] = useState({
    ...
    email: '',
    message: '',
    resturant: 'Alt Mariendorf',
    subject: 'Inquiry regarding Alt Mariendorf',
  });
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: '', phone: '', email: '', message: '', resturant: ' Alt Mariendorf' ,subject: 'Inquiry regarding Alt Mariendorf'});
      } else {
