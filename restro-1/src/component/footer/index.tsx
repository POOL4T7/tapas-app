...
const Footer = (props: any) => {
  ...
  const firstSegment = language.find((segment) => ["en", "de", "es"].includes(segment)) || "";
  const LinkM = {
  ...
  const data = {
    ...
    link:`/${firstSegment ? firstSegment + '/' : ''}kontakt` ,
      ...
      <footer className={styles.footerN}>
        <div className={styles.footerContainerN}>
          ...
          <div className={styles.logo}>
            <Image src={data.img} width={200} height={200} alt='img' />
          </div>
