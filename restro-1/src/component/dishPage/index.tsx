...
const DishPage = ({blogData}:any) => {
  ...
  //   description: [
  //     "Amazing taste with fresh ingredients and delightful spices.",
  //     "A perfect blend of flavors for your palate.",
  //     "Prepared by our expert chefs with utmost care.",
  //     "A dish that brings joy to every bite.",
  //     "Don’t miss out on this gastronomic experience!",
  //   ],
  //   checklist: [
  ...
  //   additionalDetails: {
  //     header: "More Details",
  //     text: "Our dish is crafted with love and passion to ensure a delightful culinary experience. Perfect for any occasion and enjoyed by all age groups.",
  //   },
  //   notes: {
  //     header: "Notes",
